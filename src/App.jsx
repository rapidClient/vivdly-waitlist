...
function App() {
  ...
  return (
    <div className="min-h-screen smbg-image md:bg-image flex flex-col">
      <div className="flex-1 px-4 sm:px-8 md:px-16 lg:px-44 pt-8 md:pt-16">
        ...
        <div className="z-10 mt-8 md:mt-12 w-full mx-auto">
          <div className="bg-border backdrop-blur-xl bg-white/10 rounded-4xl p-6 md:p-12 shadow-xl border border-white/20 transition-all duration-300 hover:bg-white/15">
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-20 justify-between">
              <div className="space-y-6 md:space-y-8 lg:space-y-12 lg:w-[56%]">
                <h1 className="text-3xl lg:text-[56px] font-bold text-[#FFEBF4]">
                  Unleash Ad Mastery: Vividly's AI Transforms Every Campaign into a Masterpiece
                </h1>
                <p className="font-semibold text-[#FFEBF4] text-base md:text-[18px] leading-relaxed">
              ...
              <div className="space-y-6 md:space-y-8 lg:w-[44%]">
                <h3 className="text-[#FFF1EB] font-semibold text-xl md:text-2xl">Why Choose VIVIDLY?</h3>
                <ul className="space-y-4 md:space-y-5">
                  {[
                    ...
                    <li key={index} className="flex items-start gap-3 group">
                      ...
                      <span className="text-[#FFEBF4] text-base md:text-lg group-hover:text-white transition-colors leading-relaxed font-semibold">
                        {item}
                      </span>
                    </li>
                  ))}
